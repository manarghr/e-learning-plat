...
<header>
    <div class="container">
        ...
        <nav>
            <ul class="nav-links">
                <li><a href="index.html" <?php echo (basename($_SERVER['PHP_SELF']) == 'index.html' || basename($_SERVER['PHP_SELF']) == 'index.php') ? 'class="active"' : ''; ?>>HOME</a></li>
                <li><a href="About-us.html" <?php echo (basename($_SERVER['PHP_SELF']) == 'About-us.html') ? 'class="active"' : ''; ?>>ABOUT US</a></li>
                ...
                <li><a href="contact-us.html" <?php echo (basename($_SERVER['PHP_SELF']) == 'contact-us.html') ? 'class="active"' : ''; ?>>CONTACT US</a></li>
            </ul>
        </nav>
        <div class="sign-in">
            <?php if ($logged_in): ?>
